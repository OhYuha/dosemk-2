// 서버가 실행되는 동안 IP별 마지막 요청 시간을 저장할 객체 (메모리 캐시)
...
export default async function handler(req, res) {
    ...
    // 백엔드 필수 유효성 검증 (악의적인 빈 데이터 전송 방지)
